...
import dda.silabo.estructura.unidad.estrategias.iu.EstrategiasIU;
...
//                PdfPCell titulo = new PdfPCell(new Paragraph("ESCUELA SUPERIOR POLITÉCNICA DE CHIMBORAZO" + "\n" + "VICERRECTORADO ACADEMICO" + "\n" + "DIRECCION DE DESARROLLO ACADEMICO", fuenteTitulo));
                titulo.setBorder(0);
...
/////////////////////////////////////////////////////////////////////////////////////////////////            
                ...
                doc.add(new Paragraph("\n"));
                doc.add(new Paragraph("1. Datos generales y específicos de la asignatura", obtenerfuentePDF("tituloSeccion")));
                doc.add(new Paragraph("\n"));
...
///////////////////////////////////////////////////////SECCION ESTRUCTURA Y DESARROLLO/////////////////////////////////////////////////////////////////////////////////////
                doc.add(new Paragraph("2. Estructura y Desarrollo de la asignatura", obtenerfuentePDF("tituloSeccion")));
                doc.add(new Paragraph("\n"));
                silabo.setIdSilabo(IdSilabo);
                Integer NumUnidades = numUnidadesSilaboCargar(G.toJson(silabo));
                if (NumUnidades > 0) {
...
/////////////////////////////////////////////////////////////////////////////ESCENARIOS DE APRENDIAZJE///////////////////////////////////////////////////////////////////////
                Paragraph ea = new Paragraph("3. Escenario de aprendizaje", obtenerfuentePDF("tituloSeccion"));
                doc.add(ea);
...
//            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                Paragraph ce = new Paragraph("4. Criterios normativos para la evaluación de la asignatura", obtenerfuentePDF("tituloSeccion"));
                doc.add(ce);
                doc.add(new Paragraph("\n"));
                doc.add(tablaCriteriosEvaluacion(IdSilabo));
                doc.add(new Paragraph("\n"));
//
                Paragraph b = new Paragraph("5. Bibliografía básica y complementaria", obtenerfuentePDF("tituloSeccion"));
                doc.add(b);
                doc.add(new Paragraph("\n"));
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                doc.add(new Paragraph("\n"));
                doc.add(new Paragraph("6. Perfil del profesor que imparte la asignatura", obtenerfuentePDF("tituloSeccion")));
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public String bibliografiasAPASitio(BibliografiaSitioWeb bs) {
        ...
        result += s.obtenerAutorAPA(bs.getAutor());
        if (bs.getAnio() != 0) {
            result += "(";
            if (bs.getDia() != 0) {
                result += bs.getDia() + " de ";
    ...
    private PdfPTable tablaDatosGenerales(DatosGenerales datosG) {
        ...
        table.addCell(new Paragraph("SÍLABO ", obtenerfuentePDF("tituloTabla")));
        PdfPCell silabocell = new PdfPCell(new Paragraph(datosG.getSilabo_materia()));
        silabocell.setColspan(2);
        table.addCell(silabocell);
        table.addCell(new Paragraph("SEMESTRE ", obtenerfuentePDF("tituloTabla")));
        ...
        informacion = new PdfPCell(new Paragraph("NÚMERO DE  CRÉDITOS ", obtenerfuentePDF("tituloTabla")));
        informacion.setVerticalAlignment(Element.ALIGN_CENTER);
        informacion.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(informacion);
        ...
        informacion.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(informacion);
        Long nc = Math.round(datosG.getNumero_creditos());
        informacion = new PdfPCell(new Paragraph(nc.toString()));
        informacion.setVerticalAlignment(Element.ALIGN_CENTER);
        informacion.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(informacion);
...
//        objetivodesp.add(new Phrase(objetivoUnidad, obtenerfuentePDF("contenidoTabla")));//cambie
        objetivounidadT.add(new Phrase(objetivoUnidad, obtenerfuentePDF("contenidoTabla")));//cambie
...
//        objetivocell.addElement(objetivodesp);//cambie 2
        ...
        PdfPCell estrategias2 = new PdfPCell(new Paragraph("ESTRATEGIAS METODOLOGICAS", obtenerfuentePDF("tituloTabla")));
    ...
    private PdfPTable tablaCriteriosEvaluacion(Integer IdSilabo) {
        ...
        try {
            ...
            float[] tableCriterios = {30f, 12f, 12f, 12f, 17f, 17f};
...
//
            ...
            Logger.getLogger(SilaboNoVigente.class.getName()).log(Level.SEVERE, null, ex);
        }
        return tcriterios;
    }
...
//            tbibliografia.addCell(celdabibliografia);
    ...
    private Element tablaInformacionDocentes(DatosDocentesIU docentes, DatosDocentesIU docentesTotal) {
        ...
        if (docentes != null) {
            ...
            for (DatoDocente Docente : totalDocentes) {
                ...
                tblPerfilProfe.addCell(new Paragraph("NOMBRE DEL DOCENTE ", obtenerfuentePDF("tituloTabla")));
                ...
                tblPerfilProfe.addCell(new Paragraph(Docente.getCorreo(), obtenerfuentePDF("contenidoTabla")));
    ...
    private Element tablaFirmaResponsables(DatosDocentesIU docentes, String codigoCampo, Silabo silabo) {
        ...
        for (DatoDocente datoDocente : docentes.getDatosdocentes()) {
            ...
            Phrase nombre = new Phrase(nombreDocente, obtenerfuentePDF("contenidoTabla"));
            Phrase rol = new Phrase("FIRMA DEL DOCENTE DE LA ASIGNATURA", obtenerfuentePDF("contenidoTablaTitulo"));
//            Phrase rol = new Phrase("FIRMA DEL DOCENTE DE LA ASIGNATURA", obtenerfuentePDF("contenidoFirmas"));
            PdfPTable tblDatosFirmas = new PdfPTable(1);
            PdfPCell cell11 = new PdfPCell(nombre);
            cell11.setVerticalAlignment(Element.ALIGN_CENTER);
            cell11.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell11.setBorder(0);
            PdfPCell cell22 = new PdfPCell(rol);
            cell22.setVerticalAlignment(Element.ALIGN_CENTER);
            cell22.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell22.setBorder(0);
            tblDatosFirmas.addCell(cell11);
            tblDatosFirmas.addCell(cell22);
...
//            Phrase nombre = new Phrase("" + nombreDocente, obtenerfuentePDF("tituloTabla"));
            Phrase rol = new Phrase(datoDocente.getRol(), obtenerfuentePDF("contenidoTablaTitulo"));
//            Phrase rol = new Phrase(datoDocente.getRol(), obtenerfuentePDF("contenidoFirmas"));
            PdfPTable tblDatosFirmas = new PdfPTable(1);
            PdfPCell cell11 = new PdfPCell(nombre);
            cell11.setVerticalAlignment(Element.ALIGN_CENTER);
            cell11.setHorizontalAlignment(Element.ALIGN_CENTER);
    ...
    private Element tablaParametrosSilabo() {
        String jsonParametro = parametroSilaboCargar(1);
    ...
    private static Integer numUnidadesSilaboCargar(java.lang.String arg0) {
        dda.silabo.sw.SilaboSW_Service service = new dda.silabo.sw.SilaboSW_Service();
        dda.silabo.sw.SilaboSW port = service.getSilaboSWPort();
        return port.numUnidadesSilaboCargar(arg0);
    }
}
